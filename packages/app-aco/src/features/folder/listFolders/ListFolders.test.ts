...
describe("ListFolders", () => {
    ...
    it("should be able to list folders", async () => {
        const listFolders = ListFolders.instance(type, gateway);
    ...
    it("should return empty array if no folders are found", async () => {
        ...
        const listFolders = ListFolders.instance(type, emptyGateway);
    ...
    it("should handle gateway errors gracefully", async () => {
        ...
        const listFolders = ListFolders.instance(type, errorGateway);
    ...
    it("should clear cache when type changes", async () => {
        ...
        const newListFolders = ListFolders.instance(newType, gateway);
