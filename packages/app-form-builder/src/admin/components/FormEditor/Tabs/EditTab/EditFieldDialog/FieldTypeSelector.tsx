...
const FbFormModelFieldSelector = ({ fieldType, onClick }: FbFormModelFieldSelectorProps) => {
    return (
        <div
            ...
            onClick={onClick}
            className={
                "wby-p-lg wby-flex wby-items-center wby-justify-center wby-bg-neutral-dimmed wby-rounded-lg wby-text-center hover:wby-bg-neutral-muted wby-transition-all wby-duration-200 wby-cursor-pointer"
            }
        >
            <div>
                <Icon
