...
import GqlErrorOverlay from "./GqlErrorOverlay";
...
const createGqlErrorOverlay = (params: CreateErrorOverlayParams): void => {
    ...
    render(<GqlErrorOverlay query={query} networkError={networkError} />, container);
};

export default createGqlErrorOverlay;
