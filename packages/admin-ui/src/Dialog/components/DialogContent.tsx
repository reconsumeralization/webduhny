...
>(({ className, dismissible, children, ...props }, ref) => {
    ...
    return (
        <DialogPrimitive.Content
            ...
            ref={ref}
            className={cn(
                "wby-fixed wby-left-[50%] wby-top-[50%] wby-z-50 wby-grid wby-w-full wby-max-w-lg wby-border wby-bg-neutral-base wby-shadow-lg focus-visible:outline-none wby-rounded-xl wby-text-md wby-text-neutral-strong",
