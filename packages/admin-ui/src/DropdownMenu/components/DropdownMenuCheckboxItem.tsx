...
>(({ className, content, checked, ...props }, ref) => (
    ...
    >
        <div
            className={cn(
                "wby-flex wby-min-size-md wby-px-sm wby-py-xs-plus wby-gap-sm-extra wby-items-center wby-text-md wby-rounded-sm wby-group-focus:bg-neutral-dimmed wby-transition-colors",
