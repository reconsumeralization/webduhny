...
const SidebarRoot = ({ side = "left", className, children, ...props }: SidebarRootProps) => {
    ...
    return (
        ...
        >
            <div
                className={cn(
                    "wby-duration-175 wby-relative wby-h-svh wby-w-[--sidebar-width] wby-bg-transparent wby-transition-[width] wby-ease-linear",
            ...
            <div
                className={cn(
                    "wby-duration-175 wby-fixed wby-inset-y-0 wby-z-10 wby-h-svh wby-w-[--sidebar-width] wby-transition-[width] wby-ease-linear md:wby-flex",
